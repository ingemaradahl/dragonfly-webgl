...
cls.WebGLTrace = function()
{
  ...
  this._on_trace_complete = function(msg)
  {
    ...
    var tag = tagManager.set_callback(this,
        window.webgl.examine_array_objects_eval_callback(this._examine_trace_complete, null, window.webgl.EXTRACT_ARRAY.EXTRACT, true),
        [rt_id, ctx_id]);
  ...
  this._examine_trace_complete = function(data, rt_id, ctx_id, root_object_id)
  {
    for (var i = 0; i < data.length; i++) {
      ...
      window.webgl.examine_array(this, trace, this._examine_trace_object, [rt_id, ctx_id, i], window.webgl.EXTRACT_ARRAY.EXTRACT);
    }
  };
  ...
  this._examine_trace_object = function(data, rt_id, ctx_id, trace_num)
  {
    ...
    window.webgl.examine_array(this, trace.objects,
        this._finalize_trace_object, [rt_id, ctx_id, trace_num, trace], window.webgl.EXTRACT_ARRAY.EXTRACT);
  };
  ...
  this._finalize_trace_object = function(trace_objs, rt_id, ctx_id, trace_num, trace)
  {
    ...
    window.webgl.examine_array(this, trace.snapshots,
        window.webgl.extract_array_callback(this._examine_snapshots_complete, null, true), [rt_id, ctx_id], false);
