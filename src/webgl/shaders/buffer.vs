...
attribute vec4 aVertex1Position;
attribute vec4 aVertex2Position;
...
void main(void) {
  ...
  vec4 p_p1 = mvpMatrix * vec4(aVertex1Position.xyz, 1.0);
  vec4 p_p2 = mvpMatrix * vec4(aVertex2Position.xyz, 1.0);
